  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        ...
        canonicalUrl="https://aiproof.me/slide/4"
      />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="flex gap-2">
              <div className="px-3 py-1 font-black uppercase text-xs border-4 border-black bg-accent text-accent-foreground">Slide 4 of 11</div>
              <div className="px-3 py-1 font-black uppercase text-xs border-4 border-black bg-secondary text-secondary-foreground">Context</div>
            </div>
            <Link to="/slide/5">
